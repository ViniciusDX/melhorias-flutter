...
class _RentalRescheduleListPageState
  ...
  Widget _buildHeaderRow(BuildContext context, int resultsCount) {
    final theme = FlutterFlowTheme.of(context);
    final label =
        'Showing $resultsCount request${resultsCount == 1 ? '' : 's'}';
        ...
        children: [
          ...
          Tooltip(
            ...
            child: OutlinedButton(
              onPressed:
                  _isFetching ? null : () => _fetchRequests(showLoader: true),
              style: ButtonStyle(
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        const SizedBox(height: 8),
        _buildHeaderRow(context, list.length),
        const SizedBox(height: 12),
        Expanded(
          child: Stack(
            children: [
